package com.axiom.mobile.exception.handlers;
...
import com.axiom.mobile.exception.ErrorResponse;
...
public class ServiceExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ResponseBody
  public ResponseEntity<Object> handleEntityNotFoundException(MobileNotFoundException ex) {
  ...
  public ResponseEntity<Object> handleBadRequestException(BadRequestException ex) {
    return buildErrorResponse(HttpStatus.BAD_REQUEST,  ex.getErrors().toArray(new String[ex.getErrors().size()]));
  }
