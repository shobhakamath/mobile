...
FROM maven:3.6.2-jdk-8 AS java_axiom_mobile_builder
...
COPY --from=java_axiom_mobile_builder /build_app/target/axiom-api-java-1.0.0.jar /app/

# Run the application
ENTRYPOINT ["java", "-jar", "axiom-api-java-1.0.0.jar"]